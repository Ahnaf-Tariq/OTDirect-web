        ...
        >
          ...
          <div className="flex flex-col gap-3 p-2">
            ...
            <div className="flex justify-between mx-1">
              <button className="w-full flex items-center justify-center gap-1 cursor-pointer font-mono border bg-[#7A1233] text-white rounded-xl p-2">
                <BiMessageRoundedDetail /> Message
              </button>
              <button className="w-full flex items-center justify-center gap-1 cursor-pointer font-mono border bg-white text-[#7A1233] rounded-xl p-2">
                <FaWhatsapp /> Whatsapp
              </button>
              <button className="w-full flex items-center justify-center gap-1 text-center cursor-pointer border bg-white text-[#7A1233] rounded-xl p-2">
                <IoIosCall /> Call
              </button>
            </div>
          </div>
